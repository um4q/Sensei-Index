...
_add(
    "verify_device_screen_match",
    "Verify Device & Screen Match",
    "commissioning",
    CHOICE_TYPE,
    YES_NO,
)
...
_add(
    "polarity_correct_wire_tug", "Polarity Correct & Wire Tug", "commissioning", CHOICE_TYPE, YES_NO
)
_add("heat_traced", "Heat Traced", "commissioning", CHOICE_TYPE, YES_NO)
_add("insulated", "Insulated", "commissioning", CHOICE_TYPE, YES_NO)
_add(
    "tubing_fittings_inspected", "Tubing & Fittings Inspected", "commissioning", CHOICE_TYPE, YES_NO
)
...
_add(
    "command_signal_type",
    "Verify Positioner Command Signals",
    "functional",
    CHOICE_TYPE,
    ["mA", "%"],
)
